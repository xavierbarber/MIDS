...
<p style="text-align:justify">
The objective of BIMCV (<a href="http://bimcv.cipf.es/">Medical Imaging Bank of the Valencia Region</a>) is that all this scientific knowledge be collected in a correct and efficient way. More concretely, all that knowledge refers to imaging data. Finding a way to organize this information is crucial.
</p>
